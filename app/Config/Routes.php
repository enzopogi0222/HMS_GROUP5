...
$routes->get('staff/departments-by-category', 'StaffManagement::getDepartmentsByCategory', ['filter' => 'roleauth:admin,it_staff']);
...
$routes->get('receptionist/room-management', 'RoomManagement::index', ['filter' => 'roleauth:receptionist']);
$routes->get('rooms/api', 'RoomManagement::getRoomsAPI', ['filter' => 'roleauth:admin,receptionist']);
$routes->get('room-types/api', 'RoomManagement::getRoomTypesAPI', ['filter' => 'roleauth:admin,receptionist']);
$routes->get('rooms/(:num)', 'RoomManagement::getRoom/$1', ['filter' => 'roleauth:admin,receptionist']);
$routes->get('rooms/patients', 'RoomManagement::getPatientsForAssignment', ['filter' => 'roleauth:admin,receptionist']);
$routes->post('rooms/create', 'RoomManagement::createRoom', ['filter' => 'roleauth:admin']);
$routes->post('rooms/assign', 'RoomManagement::assignRoom', ['filter' => 'roleauth:admin,receptionist']);
$routes->post('rooms/discharge', 'RoomManagement::dischargeRoom', ['filter' => 'roleauth:admin,receptionist']);
