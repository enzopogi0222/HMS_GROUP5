...
window.ViewStaffModal = {
    ...
    populateForm(staff) {
        ...
        const fields = {
            ...
            'v_date_of_birth': formatDate(staff.date_of_birth || staff.dob),
            'v_contact_no': staff.contact_no || staff.phone || '',
            'v_email': staff.email || '',
            'v_role': formatText(staff.role_name || staff.role || staff.role_slug),
            'v_department': staff.department_name || staff.department || '',
